...
const Main:FunctionComponent<{name: string}> = ({name}) => {
    ...
    const [education, setEducation] = useState<object[]>([
        ...
        {
            degree: "B.S. Anatomy of Pirates",
            description: "I learned things, and more stuff. Then I learned how to be a pirate.",
            end: {month: 11, year: 2020},
            fieldOfStudy: "",
