...
const EducationModalContent:FunctionComponent<{handleUpdate: any}>= ({ handleUpdate, prevId }) => {
    ...
    const [id, setId] = useState<number>(prevId)
    ...
    const handleSubmit = (e: any) => {
        e.preventDefault();
        let id = prevId++;
        const newEducation = { id, institution, fieldOfStudy, degree, start, end, description, current }
