    ...
    return(
        <div className={classes.modalContent}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                />
                <TextField className={classes.input} label="Degree Level (B.A., M.Sc., etc.)" variant="outlined" onChange={(e)=> setDegree(e.target.value)} required/>
                <TextField lassName={classes.input} label="Field of Study" variant="outlined" onChange={(e)=> setFieldOfStudy(e.target.value)} required/>
