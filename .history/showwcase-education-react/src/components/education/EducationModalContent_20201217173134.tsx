        ...
        <div className={classes.modalContent}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className={classes.inputGroup}>
                  <TextField className={`${classes.input} ${classes.mr}`} label="Degree Level" helperText="i.e B.A., M.Sc., etc." variant="outlined" onChange={(e)=> setDegree(e.target.value)} required/>
