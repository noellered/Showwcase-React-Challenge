    ...
    return(
        <Container>
            ...
            <Card className={classes.educationCard}>
                ...
                {months[item['start']['month']].name}{months[item['start']['month']].name}{item['current'] ? 'Present' : item['end']['year']}
                {months[item['start']['month']].name} {item['start']['year']} - {item['current'] ? 'Present' : item['end']['year']}
                </Typography>
