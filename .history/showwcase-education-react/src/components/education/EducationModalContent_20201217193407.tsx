...
const EducationModalContent:FunctionComponent<{handleUpdate: any, educationObj?: object}>= ({ handleUpdate }) => {
        ...
        <div className={classes.modalContent}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className={classes.inputGroup}>
                  <TextField className={`${classes.input} ${classes.mr}`} label="Degree Level" value={values['degree']} helperText="ex) Bachelor's, Master's, etc." variant="outlined" onChange={(e)=> setDegree(e.target.value)} required/>
                  <TextField className={classes.input} label="Field of Study" variant="outlined" value={values['fieldOfStudy']} onChange={(e)=> setFieldOfStudy(e.target.value)} required/>
                </div>
                ...
                <TextField className={classes.input} multiline fullWidth rows={3} placeholder={values['description']} variant="outlined" label="Description" onChange={(e)=> setDescription(e.target.value)}/>

                <div className={classes.inputGroup}>
                <FormControlLabel
                      control={<Switch checked={values['current']} onChange={handleSwitch} name="current" color="secondary"/>}
                      label="Current"
                />
                </div>
