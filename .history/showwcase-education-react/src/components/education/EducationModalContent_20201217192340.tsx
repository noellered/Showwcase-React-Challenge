        ...
        <div className={classes.modalContent}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className={classes.inputGroup}>
                  <TextField className={`${classes.input} ${classes.mr}`} label="Degree Level" placeholder={values['degree']} helperText="ex) Bachelor's, Master's, etc." variant="outlined" onChange={(e)=> setDegree(e.target.value)} required/>
                  <TextField className={classes.input} label="Field of Study" variant="outlined" placeholder={values['fieldOfStudy']} onChange={(e)=> setFieldOfStudy(e.target.value)} required/>
                </div>
