...
const EducationModalContent:FunctionComponent<{handleUpdate: any, autocompleteList: string{} }>= ({ handleUpdate, autocomleteList }) => {
        ...
        <Grid container className={classes.modalContent}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <Grid container lg={12} className={classes.inputGroup}>
                    ...
                    <Grid item>
                        <TextField  label="GPA" variant="outlined" onChange={(e)=> setGpa(e.target.value)}></TextField>
                    </Grid>
                </Grid>
